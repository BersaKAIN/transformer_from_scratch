...
def get_ds(config):
    ...
    print(f"Max langth of source sentences: {max_len_src}")
    print(f"Max langth of target sentences: {max_len_tgt}")
...
def train_model(config):
    ...
    for epoch in range(initial_epoch, config['num_epoch']):
        ...
        for batch in batch_iterator:
            ...
            # (B, seq_len, tgt_vocab_len) --> (B * seq_len, tgt_vocab_len)
        ...
        # Saving both the model weights and the optimizer state if you want to resume training
        torch.save({
            'epoch': epoch,
